              ...
              >
                ...
                <div className="flex flex-wrap gap-4 xl:justify-between">
                  ...
                  <button
                    ...
                    className="bg-primary hover:bg-primaryho dark:bg-btndark inline-flex items-center gap-2.5 rounded-full px-6 py-3 font-medium text-white duration-300 ease-in-out"
                  >
                    Send Message
                    <svg
